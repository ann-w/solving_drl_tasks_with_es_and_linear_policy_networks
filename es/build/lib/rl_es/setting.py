...
ENVIRONMENTS = {
    ...
    "BipedalWalker-v3": EnvSetting(
        "BipedalWalker-v3", 20_000, reward_shaping=lambda x: np.clip(x, -1, 1)
    ),
    ...
    "Hopper-v4": EnvSetting(
        "Hopper-v4", 20_000, reward_shaping=lambda x: x - 1, last_activation=np.tanh
    ),
    "HalfCheetah-v4": EnvSetting("HalfCheetah-v4", 10_000, last_activation=np.tanh),
    "Walker2d-v4": EnvSetting(
        "Walker2d-v4", 50_000, reward_shaping=lambda x: x - 1, last_activation=np.tanh
    ),
    "Ant-v4": EnvSetting(
        "Ant-v4",
        50_000,
